  ...
  return (
    ...
    >
      ...
      <div className="rounded-3xl bg-gradient-to-r from-[var(--primary)] to-violet-600 p-8 text-white shadow-xl shadow-[var(--primary)]/25 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-bold tracking-wide uppercase text-sm opacity-90">System Online</span>
          </div>
          <h2 className="text-3xl font-bold mb-2">No Active Sessions</h2>
          <p className="text-indigo-100 text-lg max-w-md">
            You are not currently parked in any VoltPark zone. Start a session to avoid tickets.
          </p>
          <div className="mt-8">
      ...
      <div className="rounded-3xl bg-white p-8 shadow-xl shadow-slate-200/50 border border-[var(--border)]">
        <h3 className="font-bold text-xl text-[var(--foreground)] mb-6">Recent Activity</h3>
        <div className="space-y-6">
           <div className="flex items-center gap-4 pb-6 border-b border-[var(--border)] last:border-0 last:pb-0">
              ...
              <div className="flex-1">
                <div className="font-bold text-[var(--foreground)]">Parking Session Ended</div>
                <div className="text-sm text-[var(--muted-foreground)]">Zone A • 2 hours ago</div>
              </div>
              <div className="font-bold text-[var(--foreground)]">$4.50</div>
           </div>
           <div className="flex items-center gap-4 pb-6 border-b border-[var(--border)] last:border-0 last:pb-0">
              ...
              <div className="flex-1">
                <div className="font-bold text-[var(--foreground)]">Payment Successful</div>
                <div className="text-sm text-[var(--muted-foreground)]">Visa ending in 4242 • Yesterday</div>
              </div>
              <div className="font-bold text-[var(--foreground)]">-$12.00</div>
           </div>
        </div>
      </div>
    </Shell>
...
function Tile({
  ...
  return (
    <div className="group flex flex-col justify-between rounded-3xl bg-white p-6 shadow-lg shadow-slate-200/50 border border-[var(--border)] transition-all hover:-translate-y-1 hover:shadow-xl h-full">
      <div>
        <div className={`mb-4 flex h-14 w-14 items-center justify-center rounded-2xl shadow-md ${color}`}>
          {icon}
        </div>
        <h3 className="font-bold text-xl text-[var(--foreground)] mb-2">{title}</h3>
      ...
      <div className="mt-6 pt-6 border-t border-[var(--border)] flex justify-end">
        <Link href={href} className="w-full">
          <Button variant="ghost" className="w-full justify-between group-hover:bg-[var(--muted)] rounded-xl h-12 text-[var(--foreground)] font-bold">
            {action}
            <svg className="w-5 h-5 text-[var(--muted-foreground)] group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
          </Button>
        </Link>
      </div>
    </div>
