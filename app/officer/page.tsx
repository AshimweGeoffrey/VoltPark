...
export default function OfficerDashboard() {
  return (
    <Shell
      ...
      actions={[
        { label: 'Issue Ticket', href: '/officer/enforcement' },
      ]}
      nav={[
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="/officer/analytics" className="group">
          <div className="h-full p-6 rounded-xl border border-[var(--border)] bg-card hover:shadow-lg transition-all group-hover:border-[var(--primary)]">
            ...
            <p className="text-[var(--muted-foreground)]">View parking occupancy, peak hours, and enforcement statistics.</p>
          </div>
        </Link>
        ...
        <Link href="/officer/sales" className="group">
          <div className="h-full p-6 rounded-xl border border-[var(--border)] bg-card hover:shadow-lg transition-all group-hover:border-[var(--primary)]">
            ...
            <p className="text-[var(--muted-foreground)]">Track daily revenue, ticket payments, and permit sales.</p>
          </div>
        </Link>
        ...
        <Link href="/officer/enforcement" className="group">
          <div className="h-full p-6 rounded-xl border border-[var(--border)] bg-card hover:shadow-lg transition-all group-hover:border-[var(--primary)]">
            ...
            <p className="text-[var(--muted-foreground)]">Issue tickets, check vehicle status, and manage violations.</p>
          </div>
        </Link>
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="bg-card border border-[var(--border)] rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-[var(--border)]">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="p-4 grid grid-cols-4 text-sm hover:bg-[var(--muted)]/20 transition-colors">
                <div className="text-[var(--muted-foreground)]">10:{15 + i} AM</div>
                <div className="font-medium">Ticket Issued #{2000 + i}</div>
                <div>Zone A - Level {i}</div>
